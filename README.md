...
An efficient way to handle building, running, testing and deploying tasks by imitating vscode's [task system](https://code.visualstudio.com/docs/editor/tasks).
...
But vim is still lack of an elegent task system to speed up your inner software development cycle (edit, compile, test). A lot of people are still dealing with those building, testing and deploying tasks in such a primitive or flaky way. Therefor, I decide to create this plugin and introduce vscode's task like machanisms to vim. 
